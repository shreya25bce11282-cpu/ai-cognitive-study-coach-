  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
      <svg width=\"180\" height=\"180\" viewBox=\"0 0 180 180\">
        ...
        <circle
          cx=\"90\" cy=\"90\" r={radius} fill=\"none\" stroke={color.stroke}
          strokeWidth=\"10\" strokeLinecap=\"round\" strokeDasharray={circumference}
          strokeDashoffset={offset} transform=\"rotate(-90 90 90)\" filter=\"url(#glow)\"
          style={{ transition: 'stroke-dashoffset 1.2s cubic-bezier(0.4, 0, 0.2, 1)' }}
        />
        <text x=\"90\" y=\"82\" textAnchor=\"middle\" fill={color.stroke} fontSize=\"36\" fontWeight=\"700\" fontFamily=\"Inter\">{score}</text>
        <text x=\"90\" y=\"108\" textAnchor=\"middle\" fill=\"#8888aa\" fontSize=\"13\" fontWeight=\"500\" fontFamily=\"Inter\">{risk} RISK</text>
      </svg>
    </div>
  );
}