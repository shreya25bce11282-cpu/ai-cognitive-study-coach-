...
export default function Dashboard() {
  ...
  // Format subject perf data for Recharts
      ...
      <div className="stats-grid">
        <GlassCard delay={1}>
          ...
          <div className="card-value">
            <StatCounter end={summary.total_sessions} />
          </div>
        </GlassCard>
        ...
        <GlassCard delay={2}>
          ...
          <div className="card-value">
            <StatCounter end={summary.total_hours} decimals={1} suffix="h" />
          </div>
        </GlassCard>
        ...
        <GlassCard delay={3}>
          ...
          <div className="card-value">
            <StatCounter end={summary.avg_session_min} decimals={0} suffix="m" />
          </div>
        </GlassCard>
      ...
      <div className="dashboard-grid">
        ...
        <GlassCard className="col-span-4" delay={5}>
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 0' }}>
            {burnout ? (
              <BurnoutGauge score={burnout.score} risk={burnout.risk} />
            ) : (
